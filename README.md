...
A comprehensive Python library for building credit scoring models (Biblioteka do budowy modeli scoringowych dla oceny ryzyka kredytowego) with a focus on:
...
## References / Literatura Referencyjna

**Main references / Główne pozycje literaturowe:**
