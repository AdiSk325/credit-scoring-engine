...
For detailed methodological guidance, see:
- **[METHODOLOGICAL_README.md](METHODOLOGICAL_README.md)** — Comprehensive guide covering literature, reject inference, calibration, and module architecture
- **[docs/references/](docs/references/)** — Additional reference materials:
  ...
  - [reject_inference.md](docs/references/reject_inference.md) — Reject Inference methods documentation
  - [calibration.md](docs/references/calibration.md) — Calibration and scoring documentation
  - [metrics.md](docs/references/metrics.md) — Metrics documentation (Gini, KS, PSI, IV)
